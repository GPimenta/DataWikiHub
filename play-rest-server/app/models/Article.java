...
//    @GeneratedValue(strategy = GenerationType.IDENTITY)
    ...
    public Article(int id, String key, String title) {
        this.id = id;
        this.key = key;
        this.title = title;
    }
...
//    public Article(int id, String key, String title, LocalDateTime latest, String contentModel, String source, String redirectTarget) {
//        this.id = id;
//        this.key = key;
//        this.title = title;
//        this.latest = latest;
