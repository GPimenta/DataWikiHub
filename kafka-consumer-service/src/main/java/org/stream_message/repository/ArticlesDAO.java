    ...
    public Optional<PageSourcePostgres> updateArticle(PageSourcePostgres pageSourcePostgres) {
        try {
            ...
            try (PreparedStatement preparedStatement = postgresSQLJDBC.getConnection().prepareStatement(UPDATE_ARTICLE)) {
                preparedStatement.setString(1, pageSourcePostgres.getTitle());
                preparedStatement.setString(2, pageSourcePostgres.getContentModel());
                preparedStatement.setString(3, pageSourcePostgres.getSource());
                preparedStatement.setTimestamp(4, Timestamp.valueOf(pageSourcePostgres.getLatest()));
                preparedStatement.setString(5, pageSourcePostgres.getRedirectTarget());
                preparedStatement.setString(6, pageSourcePostgres.getKey());
